        ...
        <div className="w-11/12 flex flex-col justify-center items-center">
            <div className="w-full flex flex-row justify-around items-center mt-5">
                <div className="w-1/2 flex flex-col justify-start items-start">
                    <label className="font-satoshi text-base font-bold text-darkblue">Quote Details</label>
                    <label className="font-satoshi text-xs font-normal text-bluegray">Created on Wed, 12th June 2022, 08:00am</label>
                </div>
                <div className="w-1/2 flex flex-row justify-end items-center">
                    <button onClick={() => navToPage('/quote-response')} className="font-satoshi bg-primary text-white rounded px-3 py-1.5 mx-1 text-xs">Respond</button>
                    <button className="flex flex-row justify-between bg-red items-center rounded px-3 py-1.5 mx-1">
            ...
            {/* Quote Information */}
            <div className="w-full h-auto flex flex-col justify-around items-center mt-5 border border-bordergray rounded px-5 py-3">
                <div className="w-full flex flex-row justify-between items-center pb-4">
                    <label className="font-satoshi text-sm font-bold text-darkblue">Quote Information</label>
                    <label className="font-satoshi text-xs text-bluegray ">Expected Delivery Date: {'2024-12-02'}</label>
                </div>
                <div className="w-full h-auto flex flex-row justify-between items-start">
                        ...
                        <div className="w-full flex flex-col justify-center items-start">
                            {quoteInfo.map((item, index) => (
                                <div key={index} className="w-full flex flex-row justify-between items-start my-1">
                                    <label className="font-satoshi text-xs text-tertiary w-2/5 text-start">{item.name}</label>
                                    <label className="font-satoshi text-xs text-slate-darkgray w-3/5 text-start flex flex-row justify-start items-center">
                                        ...
                                        {item.role && 
                                            <label className="flex flex-row w-auto justify-center items-center">
                                                <BsDot size={15} className="text-fadegray" />
                                                <label className="text-fadegray font-satoshi">{item.role}</label>
                                            </label>
                                        }
                                    </label>
                                </div>
                    ...
                    <div className="w-2/5 flex flex-col justify-end items-end my-1">
                        <div className="w-5/6 h-auto flex flex-col justify-between items-center border border-bordergray py-2.5 px-2.5 rounded">
