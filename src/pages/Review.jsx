...
const Review = () => {
    ...
    return (
        <div className="w-5/6 h-screen flex flex-col justify-start items-center overflow-auto">
            ...
            <Steps id={3} />
            {/* Quote Information */}
            <div className="w-11/12 h-auto flex flex-col justify-around items-center mt-5 border border-bordergray rounded px-5 py-3">
                <div className="w-full flex flex-row justify-between items-center pb-4">
                    <label className="font-satoshi text-sm font-bold text-darkblue">Request Information</label>
                    <label>
                        <FaEdit size={20} className="text-fadegray" />
                    </label>
                </div>
            ...
            {/* Items */}
            <div className="w-11/12 h-auto flex flex-col justify-around items-center mt-5 border border-bordergray rounded px-5 py-2">
                <div className="w-full flex flex-row justify-start items-center pb-4">
                    <label className="font-satoshi text-sm font-bold text-darkblue">Items(s)</label>
                </div>
